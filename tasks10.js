...
Проверьте работу функции по примерам использования. А так же попробуйте с её помощью вывести свой список товаров и свою функцию форматирования товара.
=======
Для каждого элемента списка вызовите функцию show передав в неё функцию, которая отформатирует товар, используя функцию из аргумента formatter.
...
Функция должна вернуть массив кнопок созданных функцией createButton. Функция createButton принимает название кнопки, и функцию, которая вызывается при «клике» на кнопку. Клик на кнопке симулируется вызывом метода click у созданной кнопки.
=======
Создайте функцию createBuyButtons, которая будет принимать список товаров, и для каждого товара из списка создаст кнопку с заголовком Купить используя функцию createButton. Вернет массив созданных кнопок. При «клике» на кнопку для товара с названием Телепорт бытовой VZHIH-101 в консоль должно выводиться Телепорт бытовой VZHIH-101 добавлен в корзину.
items — список товаров, аналогичный positions, массив
...
<<<<<<< HEAD
Для каждого элемента списка вызовите функцию createButton, передав первым аргументом строку Купить, а втором функцию которая выведет привызове название товара в консоль.
